            ...
            <div className="w-full h-11/12 flex max-sm:flex-col sm:flex-col md:flex-row justify-center lg:mb-5">
                <div className="flex flex-col items-center justify-center w-full">
                    ...
                    <h1 className="text-slate-200 text-lg font-semibold text-center w-9/12 max-sm:w-[370px] mt-3 max-sm:text-[16px]">
                        OPEN API is a community-driven platform for discovering,
                        sharing, and managing both free and paid APIs. It helps
                        developers find reliable APIs while offering a space for
                        API creators to showcase their work.
                    </h1>
                </div>
                <div
