    ...
    <div className="w-full relative min-h-screen bg-[#1a1c1ff8] flex flex-col items-center justify-start py-10">
      <div className="w-9/12 relative mx-auto md:rounded-2xl mt-20 min-h-96">
        <div className="absolute inset-0 w-full h-full bg-cover bg-center blur-md rounded-2xl">
          <img src={"/HeroBackground.png"} alt="Upload API Background" className="object-cover rounded-2xl w-full h-full" />
        </div>
          ...
          <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="flex flex-col w-full">
            ...
            <form onSubmit={handleSubmit} className="w-full mt-6 bg-[#22252b] p-8 rounded-lg shadow-2xl">
              ...
              <div className="flex justify-start gap-x-10 max-sm:gap-x-5 mt-6">
                <button type="submit" className="relative px-6 py-3 font-semibold text-white bg-transparent border border-white hover:border-transparent overflow-hidden group rounded-md transition-transform duration-300 hover:scale-105" disabled={loading}>
                  ...
                  <span className="relative z-10 text-white">{loading ? "Uploading..." : "Submit API"}</span>
                </button>
                <button type="reset" className="relative px-6 py-3 font-semibold text-white bg-transparent border border-white hover:border-transparent overflow-hidden group rounded-md transition-transform duration-300 hover:scale-105">
