            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input
                  ...
                  className="w-full px-4 py-3 text-white bg-[#1a1c1f] border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-[#64CBD2] shadow-md"
                  required
                />
              ...
              {/* <input
                ...
                className="w-full px-4 py-3 mt-4 text-white bg-[#1a1c1f] border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-[#64CBD2] shadow-md"
                required
              /> */}
