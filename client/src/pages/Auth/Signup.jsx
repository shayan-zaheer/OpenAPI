    ...
    <div className="w-full min-h-screen bg-[#1a1c1ff8] flex flex-col items-center justify-center">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="w-96 bg-[#22252b] p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          <input type="text" name="username" value={formData.username} onChange={handleChange} placeholder="Username" className="w-full px-4 py-3 text-white bg-[#1a1c1f] border border-gray-600 rounded-md mt-4" required />
        ...
        <p className="text-gray-400 text-sm text-center mt-4">Already have an account? <Link to="/login" className="text-[#00E8FC]">Login</Link></p>
      </motion.div>
    </div>
  );
};
